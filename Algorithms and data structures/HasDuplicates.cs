...
int steps = 0;
//Slow example of a function of N^2 as it uses nested loops, there is a better way to write this using python, and arrays that don't require you to set a size, whereas C# requires you to do this. Use a list I hear you say, well actually I'll need to insert a value into a space at an index, List<int> doesn't allow you to do that. So moving on.
